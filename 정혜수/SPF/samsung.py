...
plt.savefig("C:\source\SPF\chart_picture\samsung.png", dpi=300)
#plt.show()
...
try:
    with connection.cursor() as cursor:
        ...
        image = convertToBinaryData("C:\source\SPF\chart_picture\samsung.png")
        cursor.execute(sql, ('삼성', int(predict), image))          # 넣으려는 값
    connection.commit()
