...
# 주식 데이터 학습 과정을 그림 파일로 시각화
# ! 일봉차트말고 다른차트는 필요없어도 될 것 같음 ! (확인필요)
class Visualizer:
    ...
    def clear(self, xlim):
        ...
        for ax in self.axes:
            ...
            ax.ticklabel_format(useOffset=False)  # x축 간격을 일정하게 설정 (토요일, 일요일 차트는 비어있기 때문에 보기 좋게 하기 위해 없애준다)
